  ...
  return (
    <div className="p-6 md:p-8 space-y-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <GlassCard className="p-5 flex flex-col justify-between" glow>
          <div>
            ...
            <h3 className="font-bold text-slate-100 text-sm">Executive PDF Report</h3>
            <p className="text-xs text-slate-400 mt-1">Full business performance summary with deal tables & metrics</p>
          </div>
          <button
        ...
        <GlassCard className="p-5 flex flex-col justify-between" glow>
          <div>
            ...
            <h3 className="font-bold text-slate-100 text-sm">Financial Deals Excel</h3>
            <p className="text-xs text-slate-400 mt-1">Export closed revenue, commissions, and deal velocity</p>
          </div>
          <button
        ...
        <GlassCard className="p-5 flex flex-col justify-between" glow>
          <div>
            ...
            <h3 className="font-bold text-slate-100 text-sm">CRM Leads Excel</h3>
            <p className="text-xs text-slate-400 mt-1">Export lead contact records and qualification scores</p>
          </div>
          <button
        ...
        <GlassCard className="p-5 flex flex-col justify-between" glow>
          <div>
            ...
            <h3 className="font-bold text-slate-100 text-sm">Property Inventory Excel</h3>
            <p className="text-xs text-slate-400 mt-1">Export full property specs, amenities, and address list</p>
          </div>
          <button
      ...
      <GlassCard className="p-6">
        <h3 className="text-base font-bold text-slate-100 mb-4 font-display">Calculated Financial Summary</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs font-mono">
          <div className="p-3.5 rounded-xl bg-slate-950/60 border border-slate-800">
            <span className="text-slate-400 block mb-1">Closed Revenue</span>
            <span className="text-lg font-bold text-cyan-400">${metrics.totalRevenue.toLocaleString()}</span>
          </div>
          <div className="p-3.5 rounded-xl bg-slate-950/60 border border-slate-800">
            <span className="text-slate-400 block mb-1">Earned Commission</span>
            <span className="text-lg font-bold text-emerald-400">${metrics.totalCommission.toLocaleString()}</span>
          </div>
          <div className="p-3.5 rounded-xl bg-slate-950/60 border border-slate-800">
            <span className="text-slate-400 block mb-1">Lead Conversion Rate</span>
            <span className="text-lg font-bold text-blue-400">{metrics.conversionRate.toFixed(1)}%</span>
          </div>
          <div className="p-3.5 rounded-xl bg-slate-950/60 border border-slate-800">
            <span className="text-slate-400 block mb-1">Qualified Hot Leads</span>
