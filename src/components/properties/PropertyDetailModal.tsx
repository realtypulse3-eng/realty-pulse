...
export const PropertyDetailModal: React.FC<PropertyDetailModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-zinc-950/80 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl p-6 text-zinc-100">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 rounded-xl bg-zinc-800/80 hover:bg-zinc-700 text-zinc-300 z-10"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
          <div className="p-3.5 rounded-xl bg-zinc-950/60 border border-zinc-800/80 flex items-center gap-3">
          ...
          <div className="p-3.5 rounded-xl bg-zinc-950/60 border border-zinc-800/80 flex items-center gap-3">
            ...
            <div>
              <span className="text-xs text-zinc-400 block">Area</span>
          ...
          <div className="p-3.5 rounded-xl bg-zinc-950/60 border border-zinc-800/80 flex items-center gap-3">
            ...
            <div>
              <span className="text-xs text-zinc-400 block">Furnishing</span>
        ...
        <div className="p-4 rounded-xl bg-zinc-950/80 border border-cyan-500/30 mb-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-xs">
            <button
              ...
              className="p-2.5 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-zinc-200 font-medium flex items-center gap-2 transition-all hover:border-cyan-500/50"
            >
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-zinc-200 font-medium flex items-center gap-2 transition-all hover:border-blue-500/50"
            >
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-zinc-200 font-medium flex items-center gap-2 transition-all hover:border-violet-500/50"
            >
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-zinc-200 font-medium flex items-center gap-2 transition-all hover:border-emerald-500/50"
            >
        ...
        <div className="space-y-4 text-xs">
          <div>
            <h4 className="text-sm font-semibold text-zinc-200 mb-1">Property Description</h4>
            <p className="text-zinc-300 leading-relaxed bg-zinc-950/40 p-3.5 rounded-xl border border-zinc-800">
              {property.description || 'No detailed description recorded.'}
            </p>
          </div>

          <div>
            <h4 className="text-sm font-semibold text-zinc-200 mb-2">Amenities & Highlights</h4>
            <div className="flex flex-wrap gap-2">
              {property.amenities.map((amenity, idx) => (
                <span
                  key={idx}
                  className="px-3 py-1 rounded-lg bg-zinc-800/80 border border-zinc-700/80 text-zinc-300 text-xs font-medium"
                >
                  {amenity}
                </span>
              ))}
